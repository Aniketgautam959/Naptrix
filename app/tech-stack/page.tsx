...
const categories = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'React',
        version: '19.x',
        desc: 'UI with hooks and concurrent features',
      },
      {
        abbr: 'TS',
        name: 'TypeScript',
    ...
    items: [
      {
        ...
        name: 'Server Actions',
        version: 'Next 15',
        desc: 'Type-safe server mutations',
      },
      {
        abbr: 'P',
        name: 'Prisma',
        version: '6.x',
        desc: 'Type-safe ORM with PostgreSQL',
      },
      {
        abbr: 'PG',
        name: 'PostgreSQL',
    ...
    items: [
      {
        ...
        name: 'Chart.js',
        version: '4.x',
        desc: 'Sleep data visualizations',
      },
      {
        abbr: 'AI',
        name: 'Google Gemini',
        version: '2.5',
        desc: 'AI-powered sleep insights',
      },
      {
        abbr: 'T',
        name: 'next-themes',
  ...
  },
  {
    ...
    items: [
      ...
      { abbr: 'Pr', name: 'Prettier', version: '3.x', desc: 'Code formatting' },
      {
        ...
        name: 'Prisma Migrate',
        version: '6.x',
        desc: 'Database schema management',
      },
    ],
  },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-3 max-w-md mx-auto text-sm leading-relaxed">
            {totalTech} technologies powering Naptrix — built for performance,
            type safety, and a great developer experience.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {categories.map(cat => (
            ...
            >
              <div
                className={`px-6 py-4 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r ${cat.accent}`}
              >
