          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -right-6 top-1/2 -translate-y-1/2 rotate-90">
                <span className="text-slate-200 text-xs tracking-widest font-medium uppercase">
                  Dashboard
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-slate-100 border border-slate-100 rounded-xl overflow-hidden">
            <div className="bg-white p-8 hover:bg-slate-50 transition-colors duration-150">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                AI-powered insights analyze your sleep patterns and provide
            ...
            <div className="bg-white p-8 hover:bg-slate-50 transition-colors duration-150">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Monitor your sleep in real-time with detailed sleep stage
                analysis and trend history.
              </p>
            </div>
            ...
            <div className="bg-white p-8 hover:bg-slate-50 transition-colors duration-150">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Get customized sleep plans and recommendations based on your
                unique sleep profile.
              </p>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                quote:
                  'Naptrix has completely transformed my sleep schedule. I feel more energized every day. The insights are incredibly detailed and helpful.',
              },
              {
                initials: 'JD',
                name: 'John D.',
                ...
                quote:
                  'The insights from Naptrix helped me identify and fix my sleep issues. Highly recommend it to anyone serious about improving their sleep quality.',
              },
              {
                initials: 'ER',
                name: 'Emily R.',
                role: 'Health Coach',
                quote:
                  'Naptrix is easy to use and provides accurate data. A must-have for anyone looking to improve their sleep and overall well-being.',
              },
            ].map(t => (
              <div
                key={t.name}
                className="bg-white border border-slate-100 rounded-xl p-7 hover:border-slate-200 transition-colors duration-150"
              >
                {/* Stars */}
      ...
      <section className="py-24 bg-slate-950">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Join 50+ users who are already improving their sleep quality with
            Naptrix.
          </p>
